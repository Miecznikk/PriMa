...
SECRET_KEY = 'django-insecure-(od65+983a8ub4*5c8nwwv3dht9jg1xywc7#m=7c#g-0s0fz+^'
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console'],
        'level': 'INFO',  # Set the root logger level to INFO to exclude DEBUG messages
    },
    'loggers': {
        'django': {
            'handlers': ['console'],
            'level': 'INFO',  # Set the Django logger level to INFO to exclude DEBUG messages
            'propagate': False,
        },
        'myapp': {
            'handlers': ['console'],
